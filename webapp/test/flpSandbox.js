		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hotel Detail",
									"targetURL": "#zsd031hoteldetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsd031hoteldetail-display": {
								"semanticObject": "zsd031hoteldetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsd031hoteldetail",
									"url": sap.ui.require.toUrl("zsd031hoteldetail")
								}
							}
						}
					}
